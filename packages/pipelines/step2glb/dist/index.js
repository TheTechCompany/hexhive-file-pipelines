...
base_worker_1.HiveWorker(function (opts) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        return [2 /*return*/, new Promise(function (resolve, reject) {
                child_process_1.exec(path_1.default.resolve('') + "/step_to_gltf -o " + path_1.default.join(opts.pipelineDirectory, opts.jobId) + " " + opts.file, function (err, stdout, stderr) { return __awaiter(void 0, void 0, void 0, function () {
                    return __generator(this, function (_a) {
                        if (err) {
                            console.error(err);
